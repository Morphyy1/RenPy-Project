...
define config.name = _("Rick and Morti UrFU")
...
define build.name = "RickandMortiUrFU"
...
# define config.main_menu_music_fadeout = 2
...
define config.save_directory = "RickandMortiUrFU-1699871562"
